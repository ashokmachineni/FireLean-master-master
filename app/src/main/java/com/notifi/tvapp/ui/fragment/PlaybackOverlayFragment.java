...
public class PlaybackOverlayFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<Movie> movies;
        switch (mSelectedMovie.getCategory()){
            case "english_movies":
                movies = MainFragment.englishMovies;
                break;
            case "hindi_movies":
                movies = MainFragment.hindiMovies;
                break;
            case "telugu_movies":
                movies = MainFragment.teluguMovies;
                break;
            case "tamil_movies":
                movies = MainFragment.tamilMovies;
                break;
            default:
                movies = null;
                break;
